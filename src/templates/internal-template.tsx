...
export default function InternalTemplate({content, slug, relatedArticles = []}: InternalTemplateProps) {
    ...
    const imageSrc = content.meta.ogImage || content.meta.imageSrc || 'https://qxwyml8xuwxdgws0.public.blob.vercel-storage.com/tuanlelaw/assets/blog/blog_post-yNAvhDSo4RRy1AXMMtK8gQDIGJ3wjy.jpg';
                        ...
                        <div className="flex flex-col gap-8 items-start max-w-[108rem] overflow-hidden w-full">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 w-full">
                                {relatedArticles.map((article: Content) => {
                                    ...
                                    const imageSrc = article.meta.ogImage || article.meta.imageSrc || 'https://qxwyml8xuwxdgws0.public.blob.vercel-storage.com/tuanlelaw/assets/blog/blog_post-yNAvhDSo4RRy1AXMMtK8gQDIGJ3wjy.jpg';
