...
export default function TestimonialCardFull({testimonial, onMouseEnter, onMouseLeave}: TestimonialCardFullProps) {
    return (
        ...
        >
            ...
            <div className="relative h-[21px] w-[120px] flex-shrink-0 flex gap-0">
                {Array.from({length: 5}).map((_, i) => (
                    <svg key={i} width="24" height="21" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg" className="w-[24px] h-[21px]">
                        <path
            ...
            {/* Testimonial Text */}
            <p className="font-inter font-normal text-[18px] leading-[28px] text-white line-clamp-8">
                {testimonial.quote}
            </p>
            ...
            <div className="flex items-center justify-between gap-[16px]">
                ...
                <div
                    className="w-[24px] h-[24px] sm:w-[20px] sm:h-[20px] flex items-center justify-center flex-shrink-0 relative overflow-visible">
                    {/* Default: Arrow Right Up (Solar Icon Linear) */}
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                         className="w-[24px] h-[24px] sm:w-[20px] sm:h-[20px] absolute inset-0 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] opacity-100 group-hover:opacity-0 group-hover:rotate-[135deg] group-hover:scale-75">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                         className="w-[24px] h-[24px] sm:w-[20px] sm:h-[20px] absolute inset-0 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] opacity-0 group-hover:opacity-100 -rotate-[135deg] group-hover:rotate-0 scale-75 group-hover:scale-100">
