  ...
  return (
    <div className="flex flex-row gap-4 justify-between">
      <div className="flex flex-col">
        <span className="font-inter-tight font-semibold text-[34px] md:text-[52px] text-[#00356E]">400+</span>
        <span className="font-inter font-medium text-base text-[#747D85] md:mt-[-0.5rem]">Clients Served</span>
      </div>
      <div className="flex flex-col">
        <span className="font-inter-tight font-semibold text-[34px] md:text-[52px] text-[#00356E]">15+</span>
