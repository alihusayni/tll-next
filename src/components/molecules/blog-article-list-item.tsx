    ...
    >
      ...
      <div className="box-border flex flex-[1_0_0] flex-col gap-4 md:gap-8 items-start min-h-px w-full md:min-w-[240px] pb-4 pt-0 px-0 relative shrink-0">
        <div className="flex flex-col gap-2 items-start relative shrink-0 w-full">
          ...
          {/* Title */}
          <p className="font-inter-tight font-semibold text-xl md:text-2xl leading-7 md:leading-8 tracking-[-0.02em] text-[#49535D] min-w-full overflow-hidden text-ellipsis line-clamp-2">
            {title}
          </p>
