  ...
  return (
    <section className="bg-[#00356E] py-16 px-4 md:py-24 md:px-8 lg:py-32 lg:px-16 m-0">
      <div className="max-w-[82rem] mx-auto">
        <h2 className="text-4xl md:text-5xl lg:text-[62px] max-w-[38.5rem] lg:max-w-[78.5rem] text-[#9199B9] text-center font-semibold leading-[1.16] mb-32 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-16 max-w-[86.5rem] lg:items-center">
          <div className="flex-1">
            <p className="text-2xl lg:text-[32px] text-white lg:max-w-[25.5rem] max-w-[23rem] font-medium leading-7 lg:leading-[38px] mb-8">
