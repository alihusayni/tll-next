        ...
        <section className="bg-[#E8EDF2] w-full">
            <div className="max-w-[86.5rem] mx-auto px-4 lg:px-16 2xl:px-0 py-8 lg:pb-16">
                ...
                <div className="flex flex-col gap-8 py-8">
                    <h1 className="text-[3.25rem] leading-[3.25rem] lg:text-[5.75rem] lg:leading-[4.5rem] tracking-[-0.065rem] lg:tracking-[-0.115rem] font-inter-tight font-semibold text-[#071C32] max-w-[31rem]">
                        FAQ&apos;s
                    </h1>
