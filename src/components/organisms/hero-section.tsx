  ...
  return (
    <section className={`relative min-h-screen flex flex-col justify-start items-center bg-[#E8EDF2] m-0 ${className}`}>
      ...
      <div className="relative z-10 w-full max-w-[90rem] mx-auto flex flex-col gap-12 px-4 md:px-8 lg:px-16 pb-16 mt-auto">
        ...
        {/* Button */}
        <button className="group self-start bg-[#E55B1E] text-white font-inter-tight font-semibold text-[18px] uppercase rounded-md hover:bg-[#FF7031] transition-all w-[19.375rem] h-[3.25rem] hover:w-[20.5rem] flex items-center justify-start gap-4 pl-6">
          30-M free consulting
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-transform group-hover:rotate-45">
