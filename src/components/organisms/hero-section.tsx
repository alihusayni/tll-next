    ...
    <section className={`relative min-h-screen flex flex-col justify-start items-center bg-[#E8EDF2] m-0 ${className}`}>
      ...
      <div className="relative z-10 w-full max-w-[86.5rem] mx-auto flex flex-col gap-12 px-4 sm:px-8 lg:px-16 2xl:px-0 pb-16 mt-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          {/* Button */}
          <button onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })} className="group bg-[#C04B10] text-white font-inter-tight font-semibold text-[1.125rem] rounded-md hover:bg-[#E55B1E] active:bg-[#E55B1E] transition-all w-[19.375rem] h-[3.25rem] hover:w-[20.5rem] active:w-[20.5rem] flex items-center justify-start gap-4 pl-6">
