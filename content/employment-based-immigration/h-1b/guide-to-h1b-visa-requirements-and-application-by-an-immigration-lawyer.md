...
* You need to hold at least a bachelor&rsquo;s degree (or an equivalent) which is directly related to the position.
* Your foreign degree must be equivalent to at least a U.S. bachelor&rsquo;s degree.
### H1B Eligible Jobs
...
* The lowest degree it requires must be a bachelor&rsquo;s degree (or an equivalent).
...
* Prepare the documents related to the employee&rsquo;s qualifications, passport, etc.
...
* Wait for the petition approval. It is possible to track your petition status online on USCIS website by signing in to your account from&nbsp;[here](https://myaccount.uscis.gov/users/sign_up).
### Step 3: Applying for the H1B Visa by the Employee
If the petition is approved, you will get a form I-797 from USCIS. Now is the employee&rsquo;s turn to start applying for an H1B visa with the U.S. Department of State (DOS) by following these steps:
* Fill out form DS-160.
* Pay the application fee.
* Request and schedule a visa interview with the U.S. embassy.
* Provide and submit the necessary documents (original and/or copy might be needed), including your current and previous passports, receipt of the application fee, photographs, the interview appointment letter, the form I-129 and its receipt number, your employer&rsquo;s letter, your resume, and the documents for your qualifications and education.
...
### What about an H1B holder&rsquo;s Family and Dependents?
An H-4 visa is granted to the H1B visa holder&rsquo;s spouse and children (only those who are under 21). With this type of visa, they are not allowed to work in the U.S. but they can go to school and have a bank account.
